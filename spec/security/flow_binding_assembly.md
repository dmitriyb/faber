...
| BindingSet -> ContainerRunner | `Assembled{Args, Teardown}` | fragment consumed verbatim; the only docker-run assembly point is infra's |
...
fresh resolver call, fresh secret files — so between-attempt cleanup can
